            ...
            >
                ...
                {order.notes && (
                    <div className="p-6 bg-[#050a15] border-t border-white/5 flex items-start gap-4">
                        ...
                        <div>
                            <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">Observações da Ordem</p>
                            <p className="text-sm text-slate-300 italic leading-relaxed">"{smartFormatText(order.notes)}"</p>
                        </div>
                    </div>
                )}
            </motion.div>
                ...
                {showNotes && (
                    ...
                    >
                        ...
                        <div className="space-y-3 max-w-lg">
                             ...
                             <p className="text-lg text-slate-200 font-medium italic leading-relaxed whitespace-pre-wrap">
                                "{smartFormatText(order.notes)}"
                            </p>
                        </div>
